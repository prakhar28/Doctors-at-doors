<%-- 
    Document   : ravindra
    Created on : May 26, 2016, 10:54:47 PM
    Author     : suyash
--%>
                  ...
                  <li>
                    <div class="single-doctor">
                      <a class="tdoctor"  data-path-hover="m 280,34.57627 -180,0 L 0,0 180,0 z">
                        <figure>
                         <left> <img src="images/ravindra.png" /> </left>
                          <figcaption>
                                    ...
                                    <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                                        ...
                                        <div class="resp-tabs-container">
                                            ...
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-1"><span class="resp-arrow"></span>RECENTS'inscrireS'inscrire</h2><h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span>Mot de passeMot de passe</h2><h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span></h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                                <p>Dr. Ravindra kale is a Gastroenterologist and Hepatology in AB Road, Indore and has an experience of 17 years in these fields. He is a member of Association of Physicians of India (API), Indian Medical Association (IMA), Indian Society of Gastroenterology and SGEI. </p>                                            </div>
...
<h2 class="resp-accordion" role="tab" aria-controls="">
                                            ...
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-5"><span class="resp-arrow"></span></h2><h2 class="resp-accordion" role="tab" aria-controls="tab_item-6"><span class="resp-arrow"></span></h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
       <p>
Constipation,Gastroscopy ,Piles Treatment,
Liver Problems ,Endoscopy ,Loose Motion,
Gastric Problem ,Intestine Surgery ,All Gastrointestinal,Hepatobiliary and Pancreatic Disorders.
</p>
                                        </div>
                                    </div>
...
<label for="ac-1">AWARDS & RECOGNITIONS</label>
 <article class="ac-small">
   <p>Fellowship Paediatric Ophthalmological & Squint - 2007-</p>
                                </article>
                            </div>
                            <div>
...
<p>MBBS - Netaji Subhash Chandra Bose Medical College, Jabalpur, 2006<br>
MD - General Medicine - MGM Medical College, 2009<br>
DM - Gastroenterology - Sri Aurobindo Institute of Medical Sciences, 2014<br>
<strong>SPECIALIZATION:Gastroenterologist</strong></p>
                                </article>
                            </div>
                            <div>
...
<p><strong>Annapurna Gastro and Liver Clinic</strong><br>
Address:113, City Multispecialities, Bank Colony, Narendra Tiwari Marg, Annapurna Road, Indore
                                </article>
                            </div>
                            <div>
                                ...
                                <article class="ac-large">
                                    <p>Consulting Charges:RS.300<br>
