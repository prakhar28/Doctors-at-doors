<%-- 
    Document   : sanjay
    Created on : May 26, 2016, 10:56:10 PM
    Author     : suyash
--%>
...
$("ul.res").slideToggle(300, function () {
   // Animation complete.
                  ...
                  <li>
                    <div class="single-doctor">
                      <a class="tdoctor"  data-path-hover="m 280,34.57627 -180,0 L 0,0 180,0 z">
                        <figure>
                         <left> <img src="images/sanjay.png" /> </left>
                          <figcaption>
           ...
           <p><b>ENT(EYE-NOSE-THROAT) Specialist</b></p>
                        </div>
                    </div>
              </div>
                                    ...
                                    <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                                        ...
                                        <div class="resp-tabs-container">
                                            ...
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-1"><span class="resp-arrow"></span>RECENTS'inscrireS'inscrire</h2><h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span>Mot de passeMot de passe</h2><h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span></h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                                <p>Dr. Sanjay Agrawal is an ENT/ Otolaryngologist in Indore Tukoganj, Indore and has an experience of 27 years in this field. Dr. Sanjay Agrawal practices at Dr Sanjay Agrawal's Clinic in Indore Tukoganj, Indore. He is a member of Indian Medical Association (IMA)</p>                                            </div>
...
<h2 class="resp-accordion" role="tab" aria-controls="">
                                            ...
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-5"><span class="resp-arrow"></span></h2><h2 class="resp-accordion" role="tab" aria-controls="tab_item-6"><span class="resp-arrow"></span></h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
       <p>
Reconstructive Middle Ear Surgery ,Endoscopic Sinus Surgery,Surgery for Snoring,
Revision Ear Surgery ,Congenital Ear Problem Treatment, Hearing, Speech Impairment.
</p>
                                        </div>
                                    </div>
...
<label for="ac-1">AWARDS & RECOGNITIONS</label>
 <article class="ac-small">
   <p>Throughout Topper & Gold Medalist in MBBS, MD & DM - 1997<br>
Awarded � Swami Pranavanand Medical Service Award� For Excellent Patient Service. - 2005</p>
                                </article>
                            </div>
                            <div>
...
<p>MBBS - MGM Medical College, 1997<br>
Diploma in Otorhinolaryngology (DLO) - MGM Medical College, 1990
<br>
<strong>Specialization:ENT/ Otolaryngologist</strong>/p>
                                </article>
                            </div>
                            <div>
...
<p><strong>Dr. Sanjay Agrawal's Clinic</strong><br>
Address:203, Sham Tower, Second Floor, 164/2, RNT Marg, Landmark: Opp. Shree Maya Indore, Indore
                                </article>
                            </div>
                            <div>
                                ...
                                <article class="ac-large">
                                    <p>Consulting Charges:RS.400<br>
                                     <p>Timings:MON-FRI<br>
                                      <p>12:00 PM - 2:00 PM/5:00 PM - 7:00 PM  </p>
                                </article>
                            </div>
                        </section>
