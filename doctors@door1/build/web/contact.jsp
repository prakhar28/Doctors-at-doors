<%-- 
    Document   : contact
    Created on : May 24, 2016, 11:46:35 PM
    Author     : suyash
--%>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>DOCTORS@DOOR : Contact</title>
          ...
          <div class="col-lg-5 col-md-5 col-sm-6">
            <div class="contact-address">
              <div class="section-heading">
               ...
               <p>Feel <strong>Free</strong> to contact us to provide some valuable feedback,so that we can provide best facility to others.</p>
              <p>Reach us through email: <strong>feedback@doctors.com</strong></p>

                 <p> For any queries or any type of support contact our team:</p>
                  
                   <p> 1. Suyash Shrivastava : <strong>suyash.shrivastava@gmail.com</strong> </p>

                 <p> 2. Shubham Yadav : <strong>shubhamy2628@gmail.com</strong> </p>

                 <p> 3. Shaifali Silawat: <strong>shaifalisilawat28@gmail.com</strong> </p>
